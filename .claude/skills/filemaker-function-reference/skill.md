...
1. **User-Default**: Nutze die in `CLAUDE.md` / Projekt-Kontext deklarierte Hauptsprache (in fm-lab: **Deutsch / `de`**). Wenn keine explizite Vorgabe vorliegt, falle auf `en` zurück.

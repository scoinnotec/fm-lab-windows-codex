...
```bash
# Nur Englisch
bash .codex/skills/install-claris-docs/scripts/install_claris_docs.sh

# Englisch + Deutsch
bash .codex/skills/install-claris-docs/scripts/install_claris_docs.sh --lang=de

# Alle Sprachen
bash .codex/skills/install-claris-docs/scripts/install_claris_docs.sh --all

# Force (Versions-Check überspringen)
bash .codex/skills/install-claris-docs/scripts/install_claris_docs.sh --lang=de --force

# Sprachen auflisten ohne zu installieren
bash .codex/skills/install-claris-docs/scripts/install_claris_docs.sh --list-languages
```
